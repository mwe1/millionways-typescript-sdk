...
import { AnalyzeTeam, AnalyzeTeamCreateParams, AnalyzeTeamCreateResponse } from './resources/analyze-team';
import {
  CategorizeAudio,
  CategorizeAudioCreateForUserParams,
  CategorizeAudioCreateForUserResponse,
  CategorizeAudioCreateParams,
  CategorizeAudioCreateResponse,
} from './resources/categorize-audio';
import {
  CategorizeText,
  CategorizeTextClassifyByUserParams,
  CategorizeTextClassifyByUserResponse,
  CategorizeTextClassifyParams,
  CategorizeTextClassifyResponse,
} from './resources/categorize-text';
import {
  Chat,
  ChatGenerateResponseForUserParams,
  ChatGenerateResponseForUserResponse,
  ChatGenerateResponseParams,
  ChatGenerateResponseResponse,
} from './resources/chat';
import { ChatResult, ChatResultGenerateParams, ChatResultGenerateResponse } from './resources/chat-result';
import {
  ChatStream,
  ChatStreamGenerateResponseParams,
  ChatStreamGenerateResponseResponse,
} from './resources/chat-stream';
import { CreateUser, CreateUserCreateParams, CreateUserCreateResponse } from './resources/create-user';
import { GetCall, GetCallRetrieveParams, GetCallRetrieveResponse } from './resources/get-call';
import {
  GetUser,
  GetUserListParams,
  GetUserListResponse,
  GetUserRetrieveParams,
  GetUserRetrieveResponse,
} from './resources/get-user';
import {
  GetUserAnalysis,
  GetUserAnalysisRetrieveParams,
  GetUserAnalysisRetrieveResponse,
} from './resources/get-user-analysis';
import {
  GetUserChatRetrieveParams,
  GetUserChatRetrieveResponse,
  GetUserChats,
} from './resources/get-user-chats';
import {
  MentalHealthChatbot,
  MentalHealthChatbotGenerateResponseParams,
  MentalHealthChatbotGenerateResponseResponse,
} from './resources/mental-health-chatbot';
import {
  SalesAssistant,
  SalesAssistantGenerateInsightsParams,
  SalesAssistantGenerateInsightsResponse,
} from './resources/sales-assistant';
import { Summarize, SummarizeCreateParams, SummarizeCreateResponse } from './resources/summarize';
...
export interface ClientOptions {
  /**
   * Defaults to process.env['MILLIONWAYS_API_KEY'].
   */
   ...
   *
   * Defaults to process.env['MILLIONWAYS_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['MILLIONWAYS_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Millionways API.
 */
export class Millionways {
  apiKey: string | null;
   ...
   * API Client for interfacing with the Millionways API.
   *
   * @param {string | null | undefined} [opts.apiKey=process.env['MILLIONWAYS_API_KEY'] ?? null]
   * @param {string} [opts.baseURL=process.env['MILLIONWAYS_BASE_URL'] ?? https://api.millionways.org] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('MILLIONWAYS_BASE_URL'),
    apiKey = readEnv('MILLIONWAYS_API_KEY') ?? null,
    ...opts
  }: ClientOptions = {}) {
    const options: ClientOptions = {
      apiKey,
      ...opts,
      baseURL: baseURL || `https://api.millionways.org`,
    };

    this.baseURL = options.baseURL!;
    this.timeout = options.timeout ?? Millionways.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('MILLIONWAYS_LOG'), "process.env['MILLIONWAYS_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.millionways.org';
  }
  ...
  protected stringifyQuery(query: Record<string, unknown>): string {
    return Object.entries(query)
      ...
      .map(([key, value]) => {
        ...
        throw new Errors.MillionwaysError(
  ...
  static Millionways = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static MillionwaysError = Errors.MillionwaysError;
  ...
  getCall: API.GetCall = new API.GetCall(this);
  getUserAnalysis: API.GetUserAnalysis = new API.GetUserAnalysis(this);
  getUserChats: API.GetUserChats = new API.GetUserChats(this);
  createUser: API.CreateUser = new API.CreateUser(this);
  categorizeText: API.CategorizeText = new API.CategorizeText(this);
  analyzeTeam: API.AnalyzeTeam = new API.AnalyzeTeam(this);
  categorizeAudio: API.CategorizeAudio = new API.CategorizeAudio(this);
  chat: API.Chat = new API.Chat(this);
  chatResult: API.ChatResult = new API.ChatResult(this);
  mentalHealthChatbot: API.MentalHealthChatbot = new API.MentalHealthChatbot(this);
  chatStream: API.ChatStream = new API.ChatStream(this);
  salesAssistant: API.SalesAssistant = new API.SalesAssistant(this);
...
Millionways.CreateUser = CreateUser;
Millionways.CategorizeText = CategorizeText;
Millionways.AnalyzeTeam = AnalyzeTeam;
Millionways.CategorizeAudio = CategorizeAudio;
Millionways.Chat = Chat;
Millionways.ChatResult = ChatResult;
Millionways.MentalHealthChatbot = MentalHealthChatbot;
Millionways.ChatStream = ChatStream;
...
export declare namespace Millionways {
  ...
  export {
    GetUserAnalysis as GetUserAnalysis,
  ...
  export {
    CategorizeText as CategorizeText,
  ...
  export {
    MentalHealthChatbot as MentalHealthChatbot,
  ...
  export {
    SalesAssistant as SalesAssistant,
