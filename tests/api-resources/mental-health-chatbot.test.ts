...
describe('resource mentalHealthChatbot', () => {
  // skipped: tests are disabled for the time being
  test.skip('generateResponse: only required params', async () => {
    const responsePromise = client.mentalHealthChatbot.generateResponse({ apiKey: 'apiKey' });
  ...
  test.skip('generateResponse: required and optional params', async () => {
    const response = await client.mentalHealthChatbot.generateResponse({
      apiKey: 'apiKey',
      language: 'en',
